...
<head>
    ...
    <!-- Webpage Title -->
    <title>Lodge Your Complaint Website</title>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        <div class="section-title text-danger">Why give a bad review when you can lodge a complain and see an improvement</div>
                        <h1 class="h1-large">Let Us Help You Make The Product Or Service You Enjoy Using Better </h1>
                        <p class="p-large">Very easy to use, all you need to do is select the organization name and drop your grieviances on the portal.</p>
                        <a class="btn-solid-lg" href="register.php">Create Account</a>
                        <a class="quote" href="login.php"><i class="fas fa-paper-plane"></i>Lodge Complain</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">PHP Journey</h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">JavaScript Journey</h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">UI/UX Journey</h5>
